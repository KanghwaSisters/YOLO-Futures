...
parser.add_argument('--data', type=str, required=False, default='kospi200', help='data')
parser.add_argument('--root_path', type=str, default='../YOLO-Futures/data/processed/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='kospi200_ffill_clean_version.pkl', help='data file')    
...
data_parser = {
    ...
    'kospi200':{'data':'kospi200_ffill_clean_version.pkl','T':'close','M':[6,6,6],'S':[1,1,1],'MS':[6,6,1]},
}
